    ...
    <div class="container flex-box bg-drink" v-if="brands.length != 0">
        <div class="wrap-container block-online-brands">
            <div class="block-drink-left">
                <p class="text-uppercase title-block-drink">{{$t('dessert')}}</p>
...
<style scoped>
.bg-drink { background: url('../../assets/image/Dessert.jpg') no-repeat; background-position: center; background-size: cover; }
</style>
    ...
    methods: {
        ...
        handle_get_brand() {
             return new Promise((resolve, reject) => {
                HTTP.get('recommends/brand-exhibition=Dessert').then(result => {
                    resolve(result)
